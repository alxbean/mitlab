...
loop:
	for try := 0; try < 5; try++ {
        ...
        fmt.Println("TTTTTTTTTTTTT:", cmds)
...
func TestPersist12C(t *testing.T) {
	...
	nd, cmd := cfg.nCommitted(4)
    fmt.Println("#########nd:", nd, " ###cmd:", cmd)
...
func TestPersist22C(t *testing.T) {
	...
	for iters := 0; iters < 5; iters++ {
        ...
        fmt.Println("#################disconnect:",(leader1 + 1)%servers,"###################")
        fmt.Println("#################disconnect:",(leader1 + 2)%servers,"###################")
		cfg.disconnect((leader1 + 1) % servers)
		cfg.disconnect((leader1 + 2) % servers)
        ...
        fmt.Println("#################disconnect:",(leader1 + 0)%servers,"###################")
        fmt.Println("#################disconnect:",(leader1 + 3)%servers,"###################")
        fmt.Println("#################disconnect:",(leader1 + 4)%servers,"###################")
		cfg.disconnect((leader1 + 0) % servers)
		cfg.disconnect((leader1 + 3) % servers)
		cfg.disconnect((leader1 + 4) % servers)

        fmt.Println("#################connect:",(leader1 + 1)%servers,"###################")
        fmt.Println("#################connect:",(leader1 + 2)%servers,"###################")
        ...
        fmt.Println("#################connect:",(leader1 + 4)%servers,"###################")
        fmt.Println("#################connect:",(leader1 + 0)%servers,"###################")
		cfg.connect((leader1 + 4) % servers)
		cfg.connect((leader1 + 0) % servers)
	}
